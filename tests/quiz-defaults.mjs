...
} from "../assets/js/quiz-defaults.js";
...
const defaults = await readFile(new URL("../assets/js/quiz-defaults.js", import.meta.url), "utf8");
const countdownCss = await readFile(new URL("../assets/css/countdown-neutral.css", import.meta.url), "utf8");
...
assert.match(main, /countdown-neutral\.css\?v=2/);
